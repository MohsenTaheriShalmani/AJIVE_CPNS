...
ZShape_pooled_Hippo<-preshapeMatrix_Hippo_pooled
...
ZComp_pooled_Hippo <- rbind(ZShape_pooled_Hippo,
                            pooledScale_Hippo,
                            radii_pooled_Hippo,
                            ZSpoke_pooled_Hippo)
...
# plot eigenmodes of ZShape_pooled
ZShape_pooled_Caud<-preshapeMatrix_Caud_pooled
...
# CPNG Pooled space 
# CPNG: Construct composite Z matrix and perform PCA
ZComp_pooled_Caud <- rbind(ZShape_pooled_Caud,
                           pooledScale_Caud,
                           radii_pooled_Caud,
                           ZSpoke_pooled_Caud)
...
# dpp <- DiProPerm(X=X.t, y=y, cores = 1, classifier = "md")
dpp <- DiProPerm(X=X.t, y=y)
dpp$pvalue
